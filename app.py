...
def get_account_credentials(region: str) -> str:
    r = region.upper()
    if r == "IND":
        return "uid=3828066210&password=C41B0098956AE7B79F752FCA873C747060C71D3C17FBE4794F5EB9BD71D4DA95"
    elif r == "ME":
        return "uid=4349244853&password=GARENA_KI_MKC_MFD4N_BY_KALLU_CODEX_2Y9F4"
    elif r in {"BR", "US", "SAC", "NA"}:
        return "uid=uid&password=JOBAYAR_GK6VJ"
    else:
        return "uid=4345418798&password=password"
